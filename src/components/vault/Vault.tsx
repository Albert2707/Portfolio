...
duration-500"/>
      ...
      <DrawerContent className="bg-[#222] border-[#333] h-[70%] md:h-[350px] flex justify-center w-full items-center">
        ...
        <div className="flex flex-col md:flex-row gap-2 h-auto overflow-auto md:overflow-y-hidden">
          <div className="flex flex-col h-[500px] gap-2 overflow-hidden">

            <div className="w-40 h-40 rounded-md overflow-hidden">
              <img className="w-full h-full object-cover object-center" src="https://udemy-certificate.s3.amazonaws.com/image/UC-fe1995dd-c67e-49ea-b59c-8c9c37d135e6.jpg?v=1714487116000" alt="" />
            </div>
          ...
          <div className="flex flex-col h-[500px] gap-2 overflow-hidden">
            ...
            <div className="w-40 h-40 rounded-md overflow-hidden">
              <img className="w-full h-full object-cover object-center" src="https://media.licdn.com/dms/image/v2/D4E22AQF0BSNdUM82IQ/feedshare-shrink_1280/feedshare-shrink_1280/0/1715039040267?e=1742428800&v=beta&t=vqktVPvG9b9Chm5hTkFuRN3vcOOQ58v_0ZoB1HfmYXk" alt="" />
            </div>
